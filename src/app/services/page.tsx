...
const STAFFING_ITEMS = [
  {
    icon: UserSearch,
    title: "Career Counseling",
    description:
      "We help freshers and young professionals choose and plan the right career path.",
  },
  {
    icon: FileSignature,
    title: "Hire on Contract",
    description:
      "A ready bench of experienced professionals across sectors, available to join your payroll fast.",
  },
  {
    icon: Users,
    title: "Hire an Expert",
    description:
      "We source and screen niche experts so you only meet candidates worth interviewing.",
  },
];
          ...
          <Reveal delay={100}>
            <div>
              ...
              <p className="mt-4 text-ink/70">
                Reverso Solutions provides job-oriented training with guidance from professionals
                who&apos;ve worked at top MNCs. Our team of highly experienced telecom R&amp;D
                engineers understands current market requirements and helps bridge the gap
                between industry expectations and your skill set — so you build a career with
                limitless growth, not just a certificate.
              </p>
            ...
            <Reveal delay={100} className="lg:order-1">
              <div>
                ...
                <p className="mt-4 text-ink/70">
                  ...
                  requirements — whether you&apos;re an individual planning your next career move
                  or a company that needs to hire fast, on contract, or for a hard-to-fill
                  specialist role.
                </p>
                <Link href="/contact" className="btn btn-primary mt-8">
                  Hire talent with us
          ...
          <Reveal delay={100}>
            <div>
              ...
              <p className="mt-4 text-ink/70">
                ...
                website design to content strategy, SEO, and graphic design, all under one roof.
              </p>
              <Link href="/contact" className="btn btn-primary mt-8">
                Start a web project
              </Link>
